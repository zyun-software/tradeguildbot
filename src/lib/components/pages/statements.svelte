...
<Hint
	text="ℹ️ Ви знаходетеся в заявок на вступ до гільдії <b>{guild.name}</b>. Тут будуть відображені актуальні запити на вступ до гільдії, які ви зможете затвердити або відхилити."
/>
